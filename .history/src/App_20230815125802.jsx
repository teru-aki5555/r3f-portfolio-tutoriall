...
import { Float,OrbitControls, PresentationControls,Text,useGLTF 
...
function App() {
  ...
  >
   ...
   color={"#0021a7"} intensity={50} rotation={[0.1,Math.pi,0]}
    ...
    <Text  font="public/RobotoSlab-Bold.ttf"  fontSize={0.6} position={[0,1.725,0.7]}>teru-code11.02</Text>

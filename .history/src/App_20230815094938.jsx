...
import { Float, OrbitControls, PresentationControls, useGLTF } from '@react-three/drei';
import './App.css';
import { Canvas} from "react-three-fiber";
function App() {
  const macbook = useGLTF(
   "https://vazxmixjsiawhamofees.supabase.co/storage/v1/object/public/models/macbook/model.gltf"
const Broken Wall = useGLTF(
  ...
  <PresentationControls 
   global config={{mass: 2, tention:400}}snap={{mass: 4, tention:300}}>
 ...
 <primitive object={Broken Wall.scene} position={[0,-1.5,0]}> 
 </primitive>
 </Float>
